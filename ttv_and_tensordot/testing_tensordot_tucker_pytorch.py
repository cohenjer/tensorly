...
fig = px.box(store_pd, x='dims',y='runtime', color='algorithm', log_y=True, title='HOOI algorithm runtime in Tensorly (rank=[3,3,3], 50 iterations), Pytorch Tensordot vs Tensorly naive', width=1904, height=916)
fig.update_layout(
    font=dict(size=18)
)
fig.write_image('./benchmark_tensordot_pytorch_tucker.png')
fig.show()